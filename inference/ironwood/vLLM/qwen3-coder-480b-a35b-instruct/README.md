...
prompts, etc, you can modify the settings in values.yaml. Note that you MUST replace `<YOUR_GCP_SERVICE_ACCOUNT>` in `values.yaml` with your own Google Cloud Service Account.
