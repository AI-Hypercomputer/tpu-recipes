...
In `values.yaml`, make sure to configure the placeholders appropriately for your environment:
- Replace `<YOUR_SERVICE_ACCOUNT>` with your Google Cloud Service Account.
