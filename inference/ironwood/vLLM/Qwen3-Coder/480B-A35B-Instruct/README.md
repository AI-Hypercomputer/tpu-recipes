...
## Placeholders
Before running the benchmark, please ensure you update the placeholders in `values.yaml` with your own values:
- `<YOUR_GCP_SERVICE_ACCOUNT>`: Your Google Cloud service account email.
- `gs://<YOUR_BUCKET>/Qwen3-Coder-480B-A35B-Instruct`: The path to the model checkpoint in your GCS bucket.
