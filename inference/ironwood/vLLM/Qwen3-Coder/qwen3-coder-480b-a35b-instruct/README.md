...
You must also replace `<YOUR_GCS_BUCKET>` in `values.yaml` with your own Google Cloud Storage bucket containing the model, and `<YOUR_SERVICE_ACCOUNT>` with your Google Cloud Service Account.
