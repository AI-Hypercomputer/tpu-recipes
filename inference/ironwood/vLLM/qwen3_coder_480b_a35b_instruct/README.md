...
### Configure service accounts and model paths

Before running the benchmark, please update `values.yaml` with your own values:
- Replace `<your-service-account>@<your-project>.gserviceaccount.com` with your GCP service account.
- Replace `gs://<your-bucket>/Qwen3-Coder-480B-A35B-Instruct` with your GCS bucket path containing the model.
