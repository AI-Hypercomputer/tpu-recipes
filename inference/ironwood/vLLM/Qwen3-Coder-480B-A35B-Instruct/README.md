...
prompts, etc, you can modify the settings in values.yaml. Ensure you provide your own values for any placeholders such as `YOUR_SERVICE_ACCOUNT@YOUR_PROJECT.iam.gserviceaccount.com`.
