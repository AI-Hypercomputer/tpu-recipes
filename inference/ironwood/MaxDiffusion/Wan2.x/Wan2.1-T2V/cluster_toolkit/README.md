# Inference Wan-AI/Wan2.1-T2V-14B-Diffusers workload on Ironwood GKE clusters with Cluster Toolkit.
...
-   **Hugging Face Token:** The Wan 2.1 weights are pulled from Hugging Face at
...
cd tpu-recipes/inference/ironwood/MaxDiffusion/Wan2.x/Wan2.1-T2V/cluster_toolkit
```
