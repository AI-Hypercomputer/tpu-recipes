...
prompts, etc, you can modify the settings in values.yaml. Note that you MUST update the `gcp_service_account` parameter in `values.yaml` to your own service account email.
