...
1. **Hugging Face Token**: Generate a new Hugging Face token if you don't already have one.
...
2. **Configuration**: Update `values.yaml` with your GCP service account and model GCS bucket path (if not downloading from Hugging Face).
