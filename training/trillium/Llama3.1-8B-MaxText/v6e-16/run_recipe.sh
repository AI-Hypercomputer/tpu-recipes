...
XLA_FLAGS=" \
  ...
  --xla_tpu_agf_combiner_threshold_in_bytes=268435456 \
  --xla_tpu_arf_combiner_threshold_in_bytes=268435456 \
  --xla_tpu_max_cmem_used_by_memory_space_assignment=67108864 "
