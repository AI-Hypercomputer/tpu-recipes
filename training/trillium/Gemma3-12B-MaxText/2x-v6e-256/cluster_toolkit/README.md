...
-   Precision: bfloat16
-   Chips: 512 (2 slices of v6e-256, 16x16 topology, 64 hosts per slice)
...
This recipe is optimized for 2 v6e-256 slices (16x16 topology, 64 `ct6e-standard-4t` hosts per slice).
...
region, zone, `num_slices: 2`, `machine_type: ct6e-standard-4t`,
