# Pretrain gemma4-26b workload on Ironwood GKE clusters with Kubernetes JobSet
...
### 2. Run gemma4-26b Pretraining Workload
...
# Apply the manifest
envsubst '${BASE_OUTPUT_DIR} ${WORKLOAD_NAME} ${WORKLOAD_IMAGE} ${CLUSTER_NAME}' < k8s_manifest.yaml | kubectl apply -n default -f -
```
