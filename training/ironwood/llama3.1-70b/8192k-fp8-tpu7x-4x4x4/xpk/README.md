...
-   Libtpu version: 0.0.41.dev20260501+nightly
-   Jax version: 0.10.1.dev20260502
-   Maxtext version: 1adb45ce021c39103c0266854189f47f79c88386
-   Python: 3.13
-   XPK: 1.11.0
...
cd maxtext
git checkout 1adb45ce021c39103c0266854189f47f79c88386

# Build and upload the docker image
bash src/dependencies/scripts/docker_build_dependency_image.sh \
  MODE=nightly \
  JAX_VERSION=0.10.1.dev20260502 \
  LIBTPU_VERSION=0.0.41.dev20260501+nightly
